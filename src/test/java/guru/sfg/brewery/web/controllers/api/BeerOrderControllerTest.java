...
import guru.sfg.brewery.web.controllers.security.BaseSecurity;
...
@SpringBootTest
class BeerOrderControllerTest extends BaseSecurity {
...
//    class createOrderTests {
    ...
    @WithUserDetails(DefaultBreweryLoader.STPETE_USERNAME)
    @Test
    ...
    @WithUserDetails(value = DefaultBreweryLoader.STPETE_USERNAME)
    @Test
    ...
    @WithUserDetails(value = DefaultBreweryLoader.DUNEDIN_USERNAME)
    @Test
    ...
    @Transactional
    @WithUserDetails(DefaultBreweryLoader.DUNEDIN_USERNAME)
    @Test
    ...
    @Transactional
    @WithUserDetails(ADMIN_USER_SPRING)
    @Test
